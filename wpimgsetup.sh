...
install_ols_wp(){
    cd /tmp/; wget -q https://mirror.iranserver.com/lscloud/ols1clk.sh
    chmod +x ols1clk.sh
...
install_wp_cli(){
    if [ -e /usr/local/bin/wp ]; then 
        ...
        curl -sO https://mirror.iranserver.com/lscloud/wp-cli.phar
        chmod +x wp-cli.phar
...
landing_pg(){
    ...
    curl -s https://mirror.iranserver.com/lscloud/wp-landing.html \
